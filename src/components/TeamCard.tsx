...
const TeamCard = (props: any) => {
    let twitterLink = 'https://twitter.com/' + props.item?.social?.twitter;
    let platziLink = 'https://platzi.com/p/' + props.item?.social?.platzi;
    let linkedinLink =
        'https://www.linkedin.com/in/' + props.item?.social?.linkedin;
    let githubLink = 'https://github.com/' + props.item?.social?.github;
    ...
    return (
        <>
            <div className="Card">
                ...
                />
                <p className="text-center pt-4 font-poppins font-medium">
                    {props.item?.name} <br />
                ...
                <div className="flex flex-wrap justify-center gap-2">
                    ...
                    <button className="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                        <a href={platziLink} target="_blank">
                            <Image
                                src="https://raw.githubusercontent.com/alexcamachogz/random_images/main/Platzi-logo.webp"
                                width={20}
                                height={20}
                            />
                        </a>
