...
const ContentLeft = () => {
	return (
		<div className='z-10'>
			...
			<button onClick={() => window.location.href = '/lottery'} type="button" className="animate-bounce block font-josef bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-pink-500 hover:to-yellow-500 rounded-3xl p-4 md:w-1/6 lg:w-1/4 sm:1/6 xxs:w-1/2 mx-auto mt-20 ">
