...
const ContentLeft = () => {
	return (
		<div className='z-10'>
			<h1 className='text-2xl text-center font-josef font-bold leading-1 md:text-6xl xxs:text-5xl mb-10'>
				Best NFTs Giveaways <br />
			</h1>

			<div className=' rounded-3xl p-4 2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-3/5 sm:w-3/5 xxs:w-3/4 mx-auto '>
				<p className='text-center font-josef text-1xl m-0 pt-0 lg:text-xl font-bold text-gray-700'>
					Who said you have to spend a lot of money to have an amazinf NFT?
					At Lucky NFT we offer you a revolutionary way to have NFTs with very little money.<br />
					A Draw!
				</p>
			</div>
			<button onClick={()=>window.location.href='/lottery'}  type="button" className="text-center block bg-pink-500 rounded-3xl p-4 md:w-1/6 lg:w-1/4 sm:1/6 xxs:w-1/2 mx-auto mt-20 items-center">
